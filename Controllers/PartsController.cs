...
namespace tec_parts_supply_transport_web.Controllers
{
    public class PartsController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> RegisterOutOfStock(string dataMachineNumber, string password, string workType, string dataIsPartsOnlyOder, string dataSupplyId)
        {
            try
            {
                // パスワードチェック
                ...
                // SQL作成
                string sqlUpdate = PartsRepository.CreateSQLToUpdateUpdateOutOfStock(dataMachineNumber, workType, dataIsPartsOnlyOder, dataSupplyId);
